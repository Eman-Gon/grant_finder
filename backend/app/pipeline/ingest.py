"""Stage INGEST. URL -> markdown text. Primary: httpx + trafilatura.
Fallback: Jina Reader for JS-heavy pages."""
...
async def ingest(url: str, *, bus: TelemetryBus) -> str:
    async with measure(bus, stage="ingest") as _m:
